...
public class SpaceGameOver extends JFrame {
    private Image screenImage;
    private Image background = new ImageIcon(getClass().getResource("img/SpaceGameOver.png")).getImage();
